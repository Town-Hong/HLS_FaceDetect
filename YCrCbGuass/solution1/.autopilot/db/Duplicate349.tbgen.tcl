...
set C_modelName {Duplicate349}
set C_modelType { void 0 }
set C_modelArgList {
	{ src_rows_V int 11 regular {fifo 0}  }
	{ src_cols_V int 10 regular {fifo 0}  }
	{ src_data_stream_V float 32 regular {fifo 0 volatile }  }
	{ dst1_data_stream_V float 32 regular {fifo 1 volatile }  }
	{ dst2_data_stream_V float 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src_rows_V", "interface" : "fifo", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst1_data_stream_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "dst2_data_stream_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst1_data_stream_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst1_data_stream_V", "role": "din" }} , 
 	...
 	{ "name": "dst2_data_stream_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst2_data_stream_V", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "347761"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "347761"}
]}
...
set Spec2ImplPortList { 
	...
	dst1_data_stream_V { ap_fifo {  { dst1_data_stream_V_din fifo_data 1 32 }  { dst1_data_stream_V_full_n fifo_status 0 1 }  { dst1_data_stream_V_write fifo_update 1 1 } } }
	dst2_data_stream_V { ap_fifo {  { dst2_data_stream_V_din fifo_data 1 32 }  { dst2_data_stream_V_full_n fifo_status 0 1 }  { dst2_data_stream_V_write fifo_update 1 1 } } }
}
