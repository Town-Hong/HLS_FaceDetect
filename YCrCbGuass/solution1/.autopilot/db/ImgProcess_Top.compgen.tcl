...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 231 \
    name NOR_OUTPUT_STREAM_V_data_V \
    reset_level 0 \
    sync_rst true \
    corename {nor_output} \
    metadata {  } \
    op interface \
    ports { nor_output_TDATA { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'NOR_OUTPUT_STREAM_V_data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 232 \
    name NOR_OUTPUT_STREAM_V_keep_V \
    reset_level 0 \
    sync_rst true \
    corename {nor_output} \
    metadata {  } \
    op interface \
    ports { nor_output_TKEEP { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'NOR_OUTPUT_STREAM_V_keep_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 233 \
    name NOR_OUTPUT_STREAM_V_strb_V \
    reset_level 0 \
    sync_rst true \
    corename {nor_output} \
    metadata {  } \
    op interface \
    ports { nor_output_TSTRB { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'NOR_OUTPUT_STREAM_V_strb_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 234 \
    name NOR_OUTPUT_STREAM_V_user_V \
    reset_level 0 \
    sync_rst true \
    corename {nor_output} \
    metadata {  } \
    op interface \
    ports { nor_output_TUSER { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'NOR_OUTPUT_STREAM_V_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 235 \
    name NOR_OUTPUT_STREAM_V_last_V \
    reset_level 0 \
    sync_rst true \
    corename {nor_output} \
    metadata {  } \
    op interface \
    ports { nor_output_TLAST { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'NOR_OUTPUT_STREAM_V_last_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 236 \
    name NOR_OUTPUT_STREAM_V_id_V \
    reset_level 0 \
    sync_rst true \
    corename {nor_output} \
    metadata {  } \
    op interface \
    ports { nor_output_TID { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'NOR_OUTPUT_STREAM_V_id_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 237 \
    name NOR_OUTPUT_STREAM_V_dest_V \
    reset_level 0 \
    sync_rst true \
    corename {nor_output} \
    metadata {  } \
    op interface \
    ports { nor_output_TDEST { O 1 vector } nor_output_TVALID { O 1 bit } nor_output_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'NOR_OUTPUT_STREAM_V_dest_V'"
}
}
