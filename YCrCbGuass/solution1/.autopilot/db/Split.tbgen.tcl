...
set C_modelArgList {
	...
	{ dst0_data_stream_V int 8 regular {pointer 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "src_data_stream_0_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst0_data_stream_V", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ dst0_data_stream_V sc_out sc_lv 8 signal 3 } 
	{ dst0_data_stream_V_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ dst1_data_stream_V_din sc_out sc_lv 8 signal 4 } 
	{ dst1_data_stream_V_full_n sc_in sc_logic 1 signal 4 } 
	{ dst1_data_stream_V_write sc_out sc_logic 1 signal 4 } 
	{ dst2_data_stream_V_din sc_out sc_lv 8 signal 5 } 
	{ dst2_data_stream_V_full_n sc_in sc_logic 1 signal 5 } 
	{ dst2_data_stream_V_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst0_data_stream_V", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "dst0_data_stream_V", "role": "default" }} , 
 	{ "name": "dst0_data_stream_V_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "dst0_data_stream_V", "role": "ap_vld" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "347761", "Max" : "347761"}
	, {"Name" : "Interval", "Min" : "347761", "Max" : "347761"}
]}
...
set Spec2ImplPortList { 
	...
	dst0_data_stream_V { ap_vld {  { dst0_data_stream_V out_data 1 8 }  { dst0_data_stream_V_ap_vld out_vld 1 1 } } }
