...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { gray_data_stream_V_dout { I 8 vector } gray_data_stream_V_empty_n { I 1 bit } gray_data_stream_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ret_out \
    op interface \
    ports { ret_out_din { O 64 vector } ret_out_full_n { I 1 bit } ret_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ret_out1 \
    op interface \
    ports { ret_out1_din { O 64 vector } ret_out1_full_n { I 1 bit } ret_out1_write { O 1 bit } } \
} "
}
