...
Duplicate::Duplicate(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, t_V_15_reg_111, "t_V_15_reg_111");
...
void Duplicate::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        t_V_15_reg_111 = j_V_fu_146_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond4_i_fu_126_p2.read()))) {
...
void Duplicate::thread_exitcond4_i_fu_126_p2() {
...
void Duplicate::thread_exitcond_i_fu_141_p2() {
...
void Duplicate::thread_i_V_fu_131_p2() {
...
void Duplicate::thread_j_V_fu_146_p2() {
    j_V_fu_146_p2 = (!t_V_15_reg_111.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(t_V_15_reg_111.read()) + sc_biguint<9>(ap_const_lv9_1));
}
...
void Duplicate::thread_t_V_6_cast_i_fu_137_p1() {
    t_V_6_cast_i_fu_137_p1 = esl_zext<10,9>(t_V_15_reg_111.read());
}

void Duplicate::thread_t_V_cast_i_fu_122_p1() {
