...
#ifndef __ImgProcess_Top_dcwdI__HH__
#define __ImgProcess_Top_dcwdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_dcwdI) {
    ...
    SC_CTOR(ImgProcess_Top_dcwdI):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
