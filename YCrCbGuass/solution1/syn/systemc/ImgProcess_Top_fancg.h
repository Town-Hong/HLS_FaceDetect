...
#ifndef __ImgProcess_Top_fancg__HH__
#define __ImgProcess_Top_fancg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_fancg) {
    ...
    SC_CTOR(ImgProcess_Top_fancg):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
