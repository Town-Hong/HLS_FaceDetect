...
#ifndef __ImgProcess_Top_fcsc4__HH__
#define __ImgProcess_Top_fcsc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_fcsc4) {
    ...
    SC_CTOR(ImgProcess_Top_fcsc4):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
