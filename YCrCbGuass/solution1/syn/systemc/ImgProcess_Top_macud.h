...
#ifndef __ImgProcess_Top_macud__HH__
#define __ImgProcess_Top_macud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_macud) {
    ...
    SC_CTOR(ImgProcess_Top_macud):  simcore_mac_0_U ("simcore_mac_0_U") {
