...
#ifndef __ImgProcess_Top_madEe__HH__
#define __ImgProcess_Top_madEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_madEe) {
    ...
    SC_CTOR(ImgProcess_Top_madEe):  simcore_mac_1_U ("simcore_mac_1_U") {
