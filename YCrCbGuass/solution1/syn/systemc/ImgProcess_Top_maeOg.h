...
#ifndef __ImgProcess_Top_maeOg__HH__
#define __ImgProcess_Top_maeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_maeOg) {
    ...
    SC_CTOR(ImgProcess_Top_maeOg):  simcore_mac_2_U ("simcore_mac_2_U") {
