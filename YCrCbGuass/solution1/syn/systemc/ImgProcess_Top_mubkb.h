...
#ifndef __ImgProcess_Top_mubkb__HH__
#define __ImgProcess_Top_mubkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_mubkb) {
    ...
    SC_CTOR(ImgProcess_Top_mubkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
