...
#ifndef __ImgProcess_Top_sdvdy__HH__
#define __ImgProcess_Top_sdvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_sdvdy) {
    ...
    SC_CTOR(ImgProcess_Top_sdvdy):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
