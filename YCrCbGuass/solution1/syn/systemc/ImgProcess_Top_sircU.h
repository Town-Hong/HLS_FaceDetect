...
#ifndef __ImgProcess_Top_sircU__HH__
#define __ImgProcess_Top_sircU__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_sircU) {
    ...
    SC_CTOR(ImgProcess_Top_sircU):  ACMP_sitofp_U ("ACMP_sitofp_U") {
