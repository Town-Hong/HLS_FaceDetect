...
#ifndef __ImgProcess_Top_sitde__HH__
#define __ImgProcess_Top_sitde__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_sitde) {
    ...
    SC_CTOR(ImgProcess_Top_sitde):  ACMP_sitodp_U ("ACMP_sitodp_U") {
