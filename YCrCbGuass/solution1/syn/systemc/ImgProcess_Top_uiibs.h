...
#ifndef __ImgProcess_Top_uiibs__HH__
#define __ImgProcess_Top_uiibs__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_uiibs) {
    ...
    SC_CTOR(ImgProcess_Top_uiibs):  ACMP_uitodp_U ("ACMP_uitodp_U") {
