...
#ifndef _Mat2AXIvideo_1_HH_
#define _Mat2AXIvideo_1_HH_
...
struct Mat2AXIvideo_1 : public sc_module {
    ...
    sc_in< sc_lv<32> > rows;
    sc_in< sc_lv<32> > cols;
    sc_in< sc_lv<8> > dst_mat_data_stream_s_dout;
    sc_in< sc_logic > dst_mat_data_stream_s_empty_n;
    sc_out< sc_logic > dst_mat_data_stream_s_read;
    ...
    // Module declarations
    Mat2AXIvideo_1(sc_module_name name);
    SC_HAS_PROCESS(Mat2AXIvideo_1);
    ...
    sc_signal< sc_lv<32> > output_V_data_V_1_data_out;
    ...
    sc_signal< sc_lv<32> > output_V_data_V_1_payload_A;
    sc_signal< sc_lv<32> > output_V_data_V_1_payload_B;
    ...
    sc_signal< sc_lv<4> > output_V_keep_V_1_data_out;
    ...
    sc_signal< sc_lv<4> > output_V_strb_V_1_data_out;
    ...
    sc_signal< sc_lv<1> > output_V_user_V_1_data_out;
    sc_signal< sc_logic > output_V_user_V_1_vld_in;
    sc_signal< sc_logic > output_V_user_V_1_vld_out;
    sc_signal< sc_logic > output_V_user_V_1_ack_in;
    sc_signal< sc_logic > output_V_user_V_1_ack_out;
    sc_signal< sc_lv<1> > output_V_user_V_1_payload_A;
    sc_signal< sc_lv<1> > output_V_user_V_1_payload_B;
    sc_signal< sc_logic > output_V_user_V_1_sel_rd;
    sc_signal< sc_logic > output_V_user_V_1_sel_wr;
    sc_signal< sc_logic > output_V_user_V_1_sel;
    sc_signal< sc_logic > output_V_user_V_1_load_A;
    sc_signal< sc_logic > output_V_user_V_1_load_B;
    sc_signal< sc_lv<2> > output_V_user_V_1_state;
    sc_signal< sc_logic > output_V_user_V_1_state_cmp_full;
    ...
    sc_signal< sc_lv<1> > output_V_id_V_1_data_out;
    sc_signal< sc_logic > output_V_id_V_1_vld_in;
    sc_signal< sc_logic > output_V_id_V_1_vld_out;
    sc_signal< sc_logic > output_V_id_V_1_ack_in;
    sc_signal< sc_logic > output_V_id_V_1_ack_out;
    sc_signal< sc_logic > output_V_id_V_1_sel_rd;
    sc_signal< sc_logic > output_V_id_V_1_sel;
    sc_signal< sc_lv<2> > output_V_id_V_1_state;
    sc_signal< sc_lv<1> > output_V_dest_V_1_data_out;
    sc_signal< sc_logic > output_V_dest_V_1_vld_in;
    sc_signal< sc_logic > output_V_dest_V_1_vld_out;
    sc_signal< sc_logic > output_V_dest_V_1_ack_in;
    sc_signal< sc_logic > output_V_dest_V_1_ack_out;
    sc_signal< sc_logic > output_V_dest_V_1_sel_rd;
    sc_signal< sc_logic > output_V_dest_V_1_sel;
    sc_signal< sc_lv<2> > output_V_dest_V_1_state;
    sc_signal< sc_logic > dst_mat_data_stream_s_blk_n;
    sc_signal< sc_logic > ap_CS_fsm_pp0_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< bool > ap_block_pp0_stage0;
    sc_signal< sc_lv<1> > exitcond_i_reg_268;
    sc_signal< sc_logic > output_r_TDATA_blk_n;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_exitcond_i_reg_268;
    sc_signal< sc_lv<9> > t_V_11_reg_162;
    sc_signal< sc_lv<10> > rows_V_fu_173_p1;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<9> > cols_V_fu_177_p1;
    sc_signal< sc_lv<9> > r_V_fu_181_p2;
    sc_signal< sc_lv<1> > exitcond3_i_fu_192_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<10> > i_V_fu_197_p2;
    sc_signal< sc_lv<10> > i_V_reg_263;
    ...
    sc_signal< sc_lv<9> > j_V_fu_208_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<1> > axi_last_V_fu_214_p2;
    sc_signal< sc_lv<1> > axi_last_V_reg_277;
    sc_signal< sc_lv<32> > p_Result_s_fu_223_p3;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_logic > ap_condition_pp0_exit_iter0_state3;
    sc_signal< sc_lv<10> > t_V_reg_151;
    ...
    void thread_cols_V_fu_177_p1();
    void thread_dst_mat_data_stream_s_blk_n();
    void thread_dst_mat_data_stream_s_read();
    void thread_exitcond3_i_fu_192_p2();
    ...
    void thread_output_V_dest_V_1_ack_in();
    void thread_output_V_dest_V_1_ack_out();
    void thread_output_V_dest_V_1_data_out();
    void thread_output_V_dest_V_1_sel();
    void thread_output_V_dest_V_1_vld_in();
    void thread_output_V_dest_V_1_vld_out();
    void thread_output_V_id_V_1_ack_in();
    void thread_output_V_id_V_1_ack_out();
    void thread_output_V_id_V_1_data_out();
    void thread_output_V_id_V_1_sel();
    void thread_output_V_id_V_1_vld_in();
    void thread_output_V_id_V_1_vld_out();
    ...
    void thread_output_V_user_V_1_ack_in();
    void thread_output_V_user_V_1_ack_out();
    void thread_output_V_user_V_1_data_out();
    void thread_output_V_user_V_1_load_A();
    void thread_output_V_user_V_1_load_B();
    void thread_output_V_user_V_1_sel();
    void thread_output_V_user_V_1_state_cmp_full();
    void thread_output_V_user_V_1_vld_in();
    void thread_output_V_user_V_1_vld_out();
    ...
    void thread_p_Result_s_fu_223_p3();
    void thread_r_V_fu_181_p2();
    void thread_rows_V_fu_173_p1();
