...
struct Split : public sc_module {
    ...
    sc_out< sc_lv<8> > dst0_data_stream_V;
    sc_out< sc_logic > dst0_data_stream_V_ap_vld;
    ...
    sc_signal< sc_lv<9> > t_V_1_reg_121;
    sc_signal< sc_lv<1> > exitcond1_fu_132_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<10> > i_V_fu_138_p2;
    sc_signal< sc_lv<10> > i_V_reg_160;
    ...
    sc_signal< sc_lv<10> > t_V_reg_110;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<8> > dst0_data_stream_V_preg;
    ...
    void thread_dst0_data_stream_V();
    void thread_dst0_data_stream_V_ap_vld();
