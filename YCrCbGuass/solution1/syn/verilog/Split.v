...
output  [7:0] dst0_data_stream_V;
output   dst0_data_stream_V_ap_vld;
...
reg[7:0] dst0_data_stream_V;
reg dst0_data_stream_V_ap_vld;
...
reg   [8:0] t_V_1_reg_121;
wire   [0:0] exitcond1_fu_132_p2;
wire    ap_CS_fsm_state2;
wire   [9:0] i_V_fu_138_p2;
reg   [9:0] i_V_reg_160;
...
reg   [7:0] dst0_data_stream_V_preg;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
#0 dst0_data_stream_V_preg = 8'd0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        dst0_data_stream_V_preg <= 8'd0;
    end else begin
        if (((exitcond_reg_165 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_01001))) begin
...
always @ (*) begin
    if (((exitcond_reg_165 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_01001))) begin
        dst0_data_stream_V_ap_vld = 1'b1;
    end else begin
        dst0_data_stream_V_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_165 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (dst2_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (dst1_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_165 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (dst2_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (dst1_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_reg_165 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (dst2_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (dst1_data_stream_V_full_n == 1'b0)) | ((exitcond_reg_165 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)));
end
...
assign exitcond1_fu_132_p2 = ((t_V_reg_110 == 10'd720) ? 1'b1 : 1'b0);

assign exitcond_fu_144_p2 = ((t_V_1_reg_121 == 9'd480) ? 1'b1 : 1'b0);

assign i_V_fu_138_p2 = (t_V_reg_110 + 10'd1);

assign j_V_fu_150_p2 = (t_V_1_reg_121 + 9'd1);
